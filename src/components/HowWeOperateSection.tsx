...
export const HowWeOperateSection = forwardRef<HTMLElement>((_, ref) => (
  <>
    <section ref={ref} className="space-y-4">
      <h2 className="text-xl md:text-2xl lg:text-3xl font-bold font-eb-garamond">How we operate</h2>
      <div className="grid gap-8 md:grid-cols-3">
        <div>
          <h3 className="text-base md:text-lg lg:text-xl font-bold font-eb-garamond mb-2">State-of-the-art narrative modeling</h3>
        ...
        <div>
          <h3 className="text-base md:text-lg lg:text-xl font-bold font-eb-garamond mb-2">Creative that will blow your mind</h3>
          <p className="text-sm md:text-base">
        ...
        <div>
          <h3 className="text-base md:text-lg lg:text-xl font-bold font-eb-garamond mb-2">LLM powered distribution</h3>
          <p className="text-sm md:text-base">
