...
export const HowWeOperateSection = forwardRef<HTMLElement>((_, ref) => (
  <>
    <section ref={ref} className="space-y-4">
      <h2 className="text-4xl font-bold font-groutpix">How we operate</h2>
      <div className="grid gap-8 md:grid-cols-3">
        <div>
          <h3 className="text-2xl font-bold font-groutpix mb-2">State-of-the-art narrative modeling</h3>
          <p>
            Our AI-driven approach analyzes and predicts viral potential across platforms, ensuring maximum impact for every campaign.
          </p>
        </div>
        <div>
          <h3 className="text-2xl font-bold font-groutpix mb-2">Creative that will blow your mind</h3>
          <p>
        ...
        <div>
          <h3 className="text-2xl font-bold font-groutpix mb-2">LLM powered distribution</h3>
          <p>
    ...
    <section className="space-y-4">
      <h2 className="text-4xl font-bold font-groutpix">Team</h2>
      <p className="text-lg">
