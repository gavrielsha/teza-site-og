...
export const HowWeOperateSection = forwardRef<HTMLElement>((_, ref) => (
  <>
    <section ref={ref} className="space-y-4">
      <h2 className="text-2xl md:text-3xl lg:text-4xl font-eb-garamond italic">How we operate</h2>
    ...
    <section className="space-y-4">
      <h2 className="text-2xl md:text-3xl lg:text-4xl font-eb-garamond italic">Team</h2>
