  ...
  <>
    <section ref={ref} className="space-y-4">
      ...
      <div className="grid gap-8 md:grid-cols-3">
        <div>
          <h3 className="text-base md:text-lg lg:text-xl font-matrix mb-2">State-of-the-art narrative modeling</h3>
        ...
        <div>
          <h3 className="text-base md:text-lg lg:text-xl font-matrix mb-2">Creative that will blow your mind</h3>
          <p className="text-sm md:text-base font-matrix">
        ...
        <div>
          <h3 className="text-base md:text-lg lg:text-xl font-matrix mb-2">LLM powered distribution</h3>
          <p className="text-sm md:text-base font-matrix">
